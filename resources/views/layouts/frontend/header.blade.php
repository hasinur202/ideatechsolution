...
<header>
    <div class="top-wrapper hidden-xs">
        <div class="container">
            <div class="quick-contacts pull-right"> <span><i class="fa fa-phone"></i> {{ optional($setting)->contact }}</span> <span><i class="fa fa-envelope"></i><a href="mailto:{{ optional($setting)->email }}">{{ optional($setting)->email }}</a></span> </div>
        </div>
    </div>
    ...
    <nav class="navbar navbar-default main-navigation affix-top" data-offset-top="197" data-spy="affix">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ route('home') }}"><img src="{{ asset('/images/logo/'.optional($setting)->logo) }}" alt="logo" style="width: 55%;height: 50px;"></a>
